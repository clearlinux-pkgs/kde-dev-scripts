...
Version  : 21.08.3
Release  : 33
URL      : https://download.kde.org/stable/release-service/21.08.3/src/kde-dev-scripts-21.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/kde-dev-scripts-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/kde-dev-scripts-21.08.3.tar.xz.sig
...
%prep
%setup -q -n kde-dev-scripts-21.08.3
cd %{_builddir}/kde-dev-scripts-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636069449
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kde-dev-scripts-21.08.3/COPYING %{buildroot}/usr/share/package-licenses/kde-dev-scripts/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/kde-dev-scripts-21.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/kde-dev-scripts/fcbf818f92ef8679a88f3778b12b4c8b5810545b
pushd clr-build
%make_install
popd
