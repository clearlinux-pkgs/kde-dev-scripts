...
Version  : 20.12.1
Release  : 26
URL      : https://download.kde.org/stable/release-service/20.12.1/src/kde-dev-scripts-20.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/kde-dev-scripts-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/kde-dev-scripts-20.12.1.tar.xz.sig
...
%prep
%setup -q -n kde-dev-scripts-20.12.1
cd %{_builddir}/kde-dev-scripts-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610050838
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kde-dev-scripts-20.12.1/COPYING %{buildroot}/usr/share/package-licenses/kde-dev-scripts/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/kde-dev-scripts-20.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kde-dev-scripts/fcbf818f92ef8679a88f3778b12b4c8b5810545b
pushd clr-build
%make_install
popd
